<template>
			<!-- ============================ Page Title Start================================== -->
			<page-title-section title="Contact Us" subTitle="Get in touch with us" />
			<!-- ============================ Page Title End ================================== -->
			...
			<!-- ============================ Call To Action ================================== -->
			<section class="bg-cover" style="background:#ffffff url(assets/img/form-bg-2.png)no-repeat;">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-xl-7 col-lg-10 col-md-12 col-sm-12">
							...
							<div class="call-action-wrap">
								<div class="sec-heading center">
									<h2 class="lh-base mb-3">Find The Perfect Job<br>on Job Stock That is Superb For You</h2>
								...
								<div class="call-action-buttons mt-3">
									...
									<a href="JavaScript:Void(0);" class="btn btn-lg btn-primary fw-medium px-xl-5 px-lg-4">Join Our Team</a>
								</div>
							</div>
